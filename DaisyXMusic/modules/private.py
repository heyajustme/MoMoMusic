            ...
            [
                [
                    InlineKeyboardButton(
                        "Join ADrama Lovers", url=f"https://t.me/{BOT_USERNAME}")],
                [
                    InlineKeyboardButton(
                        "Index Channel", url=f"https://t.me/{UPDATES_CHANNEL}"), 
                    InlineKeyboardButton(
                       "Discussion Group", url=f"https://t.me/{SUPPORT_GROUP}")
                ],[
                    InlineKeyboardButton(
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""** Hello there! I am MoMoMusic, Music player in @ADrama_Lovers.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
